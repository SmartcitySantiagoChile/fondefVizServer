...
class ESTripIndexTest(TestCase):
    ...
    def test_get_base_resume_data_query(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_resume_data_query, start_date,
                          end_date, day_types, periods, origin_zones, destination_zones)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_resume_data_query, start_date,
                          end_date, day_types, periods, origin_zones, destination_zones)
        end_date = '2018-02-01'
        result = self.instance.get_base_resume_data_query(start_date, end_date, day_types, periods, origin_zones,
                                                          destination_zones)
    ...
    def test_get_resume_data(self, mock_method):
        ...
        hist_query, ind_query = self.instance.get_resume_data(start_date, end_date, day_types, periods, origin_zones,
                                                              destination_zones)
    ...
    def test_get_base_map_data_query(self):
        ...
        periods = [1, 2, 3]
        sectors = [1, 2, 3]
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_map_data_query, start_date,
                          end_date, day_types, periods, sectors)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_map_data_query, start_date,
                          end_date, day_types, periods, sectors)
        end_date = '2018-02-01'
        result = self.instance.get_base_map_data_query(start_date, end_date, day_types, periods, sectors)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
            {'terms': {'periodo_subida': [1, 2, 3]}}]}}}
    ...
    def test_get_map_data(self):
        ...
        periods = [1, 2, 3]
        sectors = {'key1': 'value'}
        result = self.instance.get_map_data(start_date, end_date, day_types, periods, sectors)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
            {'terms': {'periodo_subida': [1, 2, 3]}}]}}, 'from': 0, 'aggs': {
            u'key1': {'filter': {'terms': {'zona_bajada': u'value'}}, 'aggs': {
    ...
    def test_get_base_large_travel_data_query_five_stages(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_large_travel_data_query,
                          start_date,
                          end_date, day_types, periods, n_etapas)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_large_travel_data_query,
                          start_date,
                          end_date, day_types, periods, n_etapas)
        ...
        result = self.instance.get_base_large_travel_data_query(start_date, end_date, day_types, periods, n_etapas)
        self.assertIsInstance(result, Search)
        self.assertDictEqual(result.to_dict(), expected)
    ...
    def test_get_base_large_travel_data_query(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_large_travel_data_query,
                          ...
                          end_date, day_types, periods, n_etapas)
        end_date = '2018-02-01'
        self.assertRaises(ESQueryStagesEmpty, self.instance.get_base_large_travel_data_query, start_date, end_date,
    ...
    def test_get_large_travel_data(self):
        ...
        result = self.instance.get_large_travel_data(start_date, end_date, day_types, periods, n_etapas,
    ...
    def test_get_base_from_to_map_data_query(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_from_to_map_data_query,
                          start_date, end_date, day_types, periods, minutes, stages, modes, origin_zones,
                          destination_zones)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_from_to_map_data_query,
                          start_date, end_date, day_types, periods, minutes, stages, modes, origin_zones,
                          destination_zones)
        end_date = '2018-02-01'
        result = self.instance.get_base_from_to_map_data_query(start_date, end_date, day_types, periods, minutes,
                                                               stages, modes, origin_zones, destination_zones)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
            {'terms': {'periodo_subida': [1, 2, 3]}},
            {'terms': {'mediahora_subida': [1, 2, 3]}},
            {'terms': {'n_etapas': [4, 3, 2, 1]}}, {'terms': {'modos': u'modes'}},
            {'terms': {'zona_subida': [1, 2, 3]}},
            {'terms': {'zona_bajada': [3, 2, 1]}}]}}}
    ...
    def test_get_from_to_map_data(self):
        ...
        origin_zones = [1, 2, 3]
        destination_zones = [3, 2, 1]
        result1, result2 = self.instance.get_from_to_map_data(start_date, end_date, day_types, periods, minutes, stages,
                                                              modes,
                                                              origin_zones, destination_zones)
        expected1 = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
            {'terms': {'periodo_subida': [1, 2, 3]}},
            {'terms': {'mediahora_subida': [1, 2, 3]}},
            ...
            'aggs': {u'expansion_factor': {'sum': {'field': u'factor_expansion'}},
                     u'by_zone': {'terms': {'field': u'zona_subida', 'size': 1000},
                                  'aggs': {u'distancia_ruta': {'avg': {'field': u'distancia_ruta'}},
                                           ...
                                           u'distancia_eucl': {'avg': {'field': u'distancia_eucl'}},
                                           u'tviaje': {'avg': {'field': u'tviaje'}}}}}, 'size': 0}
        expected2 = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
            {'terms': {'periodo_subida': [1, 2, 3]}},
            {'terms': {'mediahora_subida': [1, 2, 3]}},
    ...
    def test_get_base_strategies_data_query(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_strategies_data_query,
                          start_date, end_date, day_types, periods, minutes, origin_zones,
                          destination_zones)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_strategies_data_query,
                          start_date, end_date, day_types, periods, minutes, origin_zones,
                          destination_zones)
        end_date = '2018-02-01'
        self.assertRaises(ESQueryOriginZoneParameterDoesNotExist, self.instance.get_base_strategies_data_query,
                          start_date, end_date, day_types, periods, minutes, origin_zones,
                          destination_zones)
        ...
        self.assertRaises(ESQueryTooManyDestinationZonesError, self.instance.get_base_strategies_data_query,
                          ...
                          destination_zones)
        destination_zones = [3, 2, 1]
        result = self.instance.get_base_strategies_data_query(start_date, end_date, day_types, periods, minutes,
                                                              origin_zones, destination_zones)
    ...
    def test_get_strategies_data(self):
        ...
        origin_zones = [1, 2, 3]
        destination_zones = [3, 2, 1]
        result = self.instance.get_strategies_data(start_date, end_date, day_types, periods, minutes,
                                                   origin_zones, destination_zones)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'terms': {'tipodia': [u'LABORAL']}},
    ...
    def test_get_base_transfers_data_query(self):
        ...
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_transfers_data_query,
                          start_date, end_date, auth_stop_code, day_types, periods, half_hours)
        start_date = '2018-01-01'
        self.assertRaises(ESQueryDateRangeParametersDoesNotExist, self.instance.get_base_transfers_data_query,
                          start_date, end_date, auth_stop_code, day_types, periods, half_hours)
        end_date = '2018-02-01'
        ...
        result = self.instance.get_base_transfers_data_query(start_date, end_date, auth_stop_code, day_types, periods,
                                                             half_hours)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
    ...
    def test_get_transfers_data(self):
        ...
        periods = [1, 2, 3]
        half_hours = [1, 2, 3]
        result = self.instance.get_transfers_data(start_date, end_date, auth_stop_code, day_types, periods, half_hours)
        expected = {'query': {'bool': {'filter': [{'range': {
            'tiempo_subida': {u'time_zone': u'+00:00', u'gte': u'2018-01-01||/d', u'lte': u'2018-02-01||/d',
                              u'format': u'yyyy-MM-dd'}}}, {'bool': {
            'should': [{'term': {'parada_bajada_1': u'auth_stop_code'}},
