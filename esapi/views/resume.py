...
DICTIONARY = {
    ...
    'transactionWithRoute': {'name': 'Transacciones con servicio asignado', 'chartName': 'Con servicio asignado', 'order': 3},
    'transactionNumber': {'name': 'Número de transacciones', 'chartName': '', 'order': 4},
    'transactionOnTrainNumber': {'name': 'Número de transacciones en metrotren', 'chartName': 'Metrotren', 'order': 5},
    'transactionOnMetroNumber': {'name': 'Número de transacciones en metro', 'chartName': 'Metro', 'order': 6},
    'transactionOnBusNumber': {'name': 'Número de transacciones en bus', 'chartName': 'Bus', 'order': 7},
    'transactionOnBusStation': {'name': 'Transacciones en zona paga', 'chartName': 'Zona paga', 'order': 8},

    'averageVelocityInAfternoonRushTrips': {'name': 'Velocidad prom. de viajes en punta tarde (Km/H)', 'chartName': '', 'order': 9},
    'averageTimeInAfternoonRushTrips': {'name': 'Tiempo prom. de viajes en punta tarde', 'chartName': '', 'order': 10},
    'averageDistanceInAfternoonRushTrips': {'name': 'Distancia prom. de viajes en punta tarde (mts)', 'chartName': '', 'order': 11},
    'tripNumberInAfternoonRushHour': {'name': 'Número de viajes en punta tarde', 'chartName': '', 'order': 12},

    'averageVelocityInMorningRushTrips': {'name': 'Velocidad prom. de viaje en punta mañana (Km/H)', 'chartName': '', 'order': 13},
    'averageTimeInMorningRushTrips': {'name': 'Tiempo prom. de viaje en punta mañana', 'chartName': '', 'order': 14},
    'averageDistanceInMorningRushTrips': {'name': 'Distancia prom. de viajes en punta mañana (mts)', 'chartName': '', 'order': 15},
    ...
    'alightingNumberInMorningRushHour': {'name': 'Número de bajadas en punta mañana (suma sobre expansión zona-período)', 'chartName': '', 'order': 48},
    'alightingNumberInAfternoonRushHour': {'name': 'Número de bajadas en punta tarde (suma sobre expansión zona-período)', 'chartName': '', 'order': 49},
    ...
    'transactionNumberInStopsWithTypeE': {'name': 'N° de validaciones en paraderos de tipo E', 'chartName': '', 'order': 54},
    'transactionNumberInStopsWithTypeT': {'name': 'N° de validaciones en paraderos de tipo T', 'chartName': '', 'order': 55},
    'transactionNumberInStopsWithTypeL': {'name': 'N° de validaciones en paraderos de tipo L', 'chartName': '', 'order': 56},
    'transactionNumberInStopsWithTypeI': {'name': 'N° de validaciones en paraderos de tipo I', 'chartName': '', 'order': 57},
    ...
    'transactionNumberInFirstStopWithMoreValidations': {'name': 'N° de validaciones en paradero con más validaciones', 'chartName': '', 'order': 68},
    'transactionNumberInSecondStopWithMoreValidations': {'name': 'N° de validaciones en segundo paradero con más validaciones', 'chartName': '', 'order': 69},
    'transactionNumberInThirdStopWithMoreValidations': {'name': 'N° de validaciones en tercer paradero con más validaciones', 'chartName': '', 'order': 70},
    'transactionNumberInFourthStopWithMoreValidations': {'name': 'N° de validaciones en cuarto paradero con más validaciones', 'chartName': '', 'order': 71},
    'transactionNumberInFifthStopWithMoreValidations': {'name': 'N° de validaciones en quinto paradero con más validaciones', 'chartName': '', 'order': 72},
    'transactionNumberInSixthStopWithMoreValidations': {'name': 'N° de validaciones en sexto paradero con más validaciones', 'chartName': '', 'order': 73},
    'transactionNumberInSeventhStopWithMoreValidations': {'name': 'N° de validaciones en séptimo paradero con más validaciones', 'chartName': '', 'order': 74},
    'transactionNumberInEighthStopWithMoreValidations': {'name': 'N° de validaciones en octavo paradero con más validaciones', 'chartName': '', 'order': 75},
    'transactionNumberInNinethStopWithMoreValidations': {'name': 'N° de validaciones en noveno paradero con más validaciones', 'chartName': '', 'order': 76},
    'transactionNumberInTenthStopWithMoreValidations': {'name': 'N° de validaciones en décimo paradero con más validaciones', 'chartName': '', 'order': 77},

    'firstBusStopWithMoreValidations': {'name': 'Paradero de bus con más validaciones', 'chartName': '', 'order': 78},
    'secondBusStopWithMoreValidations': {'name': 'Segundo paradero de bus con más validaciones', 'chartName': '', 'order': 79},
    'thirdBusStopWithMoreValidations': {'name': 'Tercer paradero de bus con más validaciones', 'chartName': '', 'order': 80},
    'fourthBusStopWithMoreValidations': {'name': 'Cuarto paradero de bus con más validaciones', 'chartName': '', 'order': 81},
    'fifthBusStopWithMoreValidations': {'name': 'Quinto paradero de bus con más validaciones', 'chartName': '', 'order': 82},
    'sixthBusStopWithMoreValidations': {'name': 'Sexto paradero de bus con más validaciones', 'chartName': '', 'order': 83},
    'seventhBusStopWithMoreValidations': {'name': 'Séptimo paradero de bus con más validaciones', 'chartName': '', 'order': 84},
    'eighthBusStopWithMoreValidations': {'name': 'Octavo paradero de bus con más validaciones', 'chartName': '', 'order': 85},
    'ninethBusStopWithMoreValidations': {'name': 'Noveno paradero de bus con más validaciones', 'chartName': '', 'order': 86},
    'tenthBusStopWithMoreValidations': {'name': 'Décimo paradero de bus con más validaciones', 'chartName': '', 'order': 87},
    'transactionNumberInFirstBusStopWithMoreValidations': {'name': 'N° de validaciones en paradero de bus con más validaciones', 'chartName': '', 'order': 88},
    'transactionNumberInSecondBusStopWithMoreValidations': {'name': 'N° de validaciones en segundo paradero de bus con más validaciones', 'chartName': '', 'order': 89},
    'transactionNumberInThirdBusStopWithMoreValidations': {'name': 'N° de validaciones en tercer paradero de bus con más validaciones', 'chartName': '', 'order': 90},
    'transactionNumberInFourthBusStopWithMoreValidations': {'name': 'N° de validaciones en cuarto paradero de bus con más validaciones', 'chartName': '', 'order': 91},
    'transactionNumberInFifthBusStopWithMoreValidations': {'name': 'N° de validaciones en quinto paradero de bus con más validaciones', 'chartName': '', 'order': 92},
    'transactionNumberInSixthBusStopWithMoreValidations': {'name': 'N° de validaciones en sexto paradero de bus con más validaciones', 'chartName': '', 'order': 93},
    'transactionNumberInSeventhBusStopWithMoreValidations': {'name': 'N° de validaciones en séptimo paradero de bus con más validaciones', 'chartName': '', 'order': 94},
