...
from dataDownloader.csvhelper.helper import ZipManager, SpeedCSVHelper, ShapeCSVHelper, StopByRouteCSVHelper, \
    FormattedShapeCSVHelper
...
class SpeedDataWithFormattedShape(object):
    ...
    def build_file(self, file_path):
        ...
        shape_file = FormattedShapeCSVHelper(self.es_client)
        shape_file.download(zip_manager, routes=routes, start_date=start_date, end_date=end_date)
