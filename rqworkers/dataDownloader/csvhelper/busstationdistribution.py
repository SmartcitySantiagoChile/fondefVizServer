...
from rqworkers.dataDownloader.csvhelper.helper import ZipManager, BusStationDistributionCSVHelper


class BusStationDistributionData(object):
    ...
    def __init__(self, es_query, es_client=None):
        ...
        self.bus_station_dist_file = BusStationDistributionCSVHelper(self.es_client, self.es_query)

    def get_filters(self):
        return self.bus_station_dist_file.get_filter_criteria(BusStationDistributionCSVHelper.FORMATTER_FOR_WEB)
    ...
    def build_file(self, file_path):
        ...
        data_filter = self.bus_station_dist_file.get_filter_criteria(BusStationDistributionCSVHelper.FORMATTER_FOR_FILE)
